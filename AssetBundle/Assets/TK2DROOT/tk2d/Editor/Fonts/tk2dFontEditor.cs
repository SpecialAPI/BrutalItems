...
public class tk2dFontEditor : Editor 
{
	...
	{
		if (packed) return Shader.Find("tk2d/Goodies/BR_PackedTextMesh");
		else if (gradient) return Shader.Find("tk2d/BR_Blend2TexVertexColor");
		else return Shader.Find("tk2d/BR_BlendVertexColor");
	}
