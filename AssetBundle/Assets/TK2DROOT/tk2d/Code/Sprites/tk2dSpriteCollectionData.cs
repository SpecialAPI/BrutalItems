...
public class tk2dSpriteDefinition
{
	...
	public TilesetIndexMetadata metadata = new TilesetIndexMetadata();
	...
	{
		return new Bounds(new Vector3(boundsDataCenter.x, boundsDataCenter.y, boundsDataCenter.z),
		                  new Vector3(boundsDataExtents.x, boundsDataExtents.y, boundsDataExtents.z));
	}
	...
	{
		return new Bounds(new Vector3(untrimmedBoundsDataCenter.x, untrimmedBoundsDataCenter.y, untrimmedBoundsDataCenter.z),
		                  new Vector3(untrimmedBoundsDataExtents.x, untrimmedBoundsDataExtents.y, untrimmedBoundsDataExtents.z));
	}
}
	...
	void Init()
	{
		...
		if (needMaterialInstance)
		{
			if (tk2dSystem.OverrideBuildMaterial) {
				...
				{
					materialInsts[i] = new Material(Shader.Find("tk2d/BR_BlendVertexColor"));
	#if UNITY_EDITOR
